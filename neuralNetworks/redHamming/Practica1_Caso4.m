...
P1 = [1; 1; -1; 1; 1; -1]; %Limon
P2 = [1; 1; 1; -1; -1; 1]; %Naranja
P3 = [1; 1; -1; -1; -1; 1]; %Manzana
P4 = [-1; 1; -1; -1; 1; -1]; %Kiwi

%Valor entrada desconocido
P = [1; 1; 1; 1; -1; 1]; %Naranja lisa
...
matrizW_FeedForward =  [P1'; P2'; P3'; P4'];
...
%Declaramos el primer valor de epsilon 
%epsilon = 0.30;
%Declaramos el primer valor de epsilon 
epsilon = .33;
